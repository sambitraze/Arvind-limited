...
final productionColRef = Firestore.instance.collection('lineeff');

class LineEfficiency extends StatefulWidget {
  @override
  _LineEfficiencyState createState() => _LineEfficiencyState();
}

class _LineEfficiencyState extends State<LineEfficiency> {
